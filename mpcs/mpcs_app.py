...
def create_annotation_job_request():
  ...
  data = {'job_id': job_id, 'username': user, 'input_file_name': input_file_name, 's3_inputs_bucket': bucket_name, 's3_key_input_file': s3_key, 'submit_time': submit_time, 'job_status': 'PENDING'}
  ...
  resp_data = {'id': job_id, 'input_file': s3_key}
